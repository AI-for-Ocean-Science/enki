...
# Begin setup
setup_keywords = dict()
setup_keywords['name'] = 'enki'
setup_keywords['description'] = 'Inpainting of oceanographic data'
setup_keywords['author'] = 'Angelina Agabin, J. Xavier Prochaska, Peter Cornillon, Christain Buckingham'
setup_keywords['author_email'] = 'jxp@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/AI-for-Ocean-Science/enki'
